...
console.log(user.name); // Typed!`
  },
  {
    ...
    description: "Secure authentication flows with Better Auth. Social logins, email magic links, and more.",
    icon: Lock,
  ...
  },
  {
    ...
    description: "Built-in support for real-time features using Upstash Redis and Server-Sent Events.",
    icon: Zap,
  ...
  },
  {
    ...
    description: "Prisma ORM configured with PostgreSQL. Visual schema editing and type-safe queries.",
    icon: Database,
...
export const terminalSteps = [
  {
    command: "bun create-turbo@latest --example https://github.com/kitsunekode/template-nextjs-express-trpc-bettera-auth-monorepo my-app",
